...
// .wrangler/tmp/bundle-gELXBM/checked-fetch.js
...
// .wrangler/tmp/pages-bGgaKP/functionsWorker-0.5450823047378495.mjs
...
async function onRequestPost({ request }) {
  ...
  const set = /* @__PURE__ */ __name2((name, value) => `${name}=${value}; Path=/; SameSite=Lax; HttpOnly; Max-Age=${thirtyDays}`, "set");
...
async function onRequestPost2({ request }) {
  ...
  return new Response(JSON.stringify({
    ok: true,
    user: { id: uid, email, first_name: firstName, last_name: lastName, role: "Pending" }
  }), {
    headers: {
      "Content-Type": "application/json",
      "Set-Cookie": [
...
// .wrangler/tmp/bundle-gELXBM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-gELXBM/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5450823047378495.js.map
