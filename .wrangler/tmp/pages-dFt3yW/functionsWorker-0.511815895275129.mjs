...
// ../.wrangler/tmp/bundle-lbzUbJ/checked-fetch.js
...
async function onRequestPost({ request }) {
  ...
  const set = /* @__PURE__ */ __name((name, value) => `${name}=${value}; Path=/; SameSite=Lax; HttpOnly; Max-Age=${thirtyDays}`, "set");
...
// ../.wrangler/tmp/pages-dFt3yW/functionsRoutes-0.7752094617009022.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-lbzUbJ/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-lbzUbJ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.511815895275129.mjs.map
